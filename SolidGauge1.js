(function() { 
               ...
               chartscript.onload = function () {
                     ...
                     chartanmscript.onload = function () {
                      ...
                      am4core.ready(function() {
                       ...
                       const SolidGauge = document.querySelector("#__widget2").querySelector(".sapCustomWidgetWebComponent").shadowRoot.querySelector("SolidGaugediv");
                       var chart = am4core.create(SolidGauge, am4charts.SlicedChart);
    ...
    customElements.define("com-demo-solid-chart", solidGaugeNew);
})();